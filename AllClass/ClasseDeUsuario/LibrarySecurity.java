package AllClass.ClasseDeUsuario;
...
public class LibrarySecurity {
    ...
    public List<UsersLibrary> searchUsers(String name) throws NaoExistente {
    ...
    public List<UsersLibrary> getUsers() throws NaoExistente {
